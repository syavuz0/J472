...
**Task** Run the following code and describe the dataframe it outputs. **Answer This dataset describes cardin's press releases in the categories of the date, title, url of the release, and the actual text itself.**
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Answer It sorts out one of each unique word, and does not include repeats.**
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Answer All of the letters are lower case and there is no punctuation.**
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **Answer This is not interesting at all because all of the top most used words are filler words.**
...
**Task** Run the following code and describe the results. Is it more interesting than before? **Answer This is a little more interesting because you get to see the percentages for each interesting word, but because they are very low, its hard to conceptualize it compared to the entire dataset.**
...
**Task** Run the following code and describe the results. **Answer This code displays the top 10 words for each year and the percentages of each appearance.**
...
**Task** Run the following code and describe the results. **Answer This code is similar to the previous one except it calculates the percentages of appearances of two words that go together for 2021.**
...
**Task** Run the following code and describe the results. **Answer This code does the same thing except for 2022.**
...
**Task** Run the following code and describe the results. **Answer This also calculates a top 10 list of the two word phrases and the percentage of their appearances for 2023.**
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer All of these are generally pretty straightforward and easy to come to the conclusion of, and don't seem incorrect to me.**
