...
**Task** Run the following code to add a month column to our dataframe using lubridate and count the number of calls for each month. In the space below, explain what each step of the code below is doing in English. Note the "label=TRUE" part in the mutate statement. **Answer The dates have been changed to show just the month through the mutate function, then each call is added up and summarized to show the total calls during each month.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer No data points are plotted, the graph is empty.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer What is shown is a simple bar chart that reflects the count of calls per month.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer the columns are organized in ascending order which moves the chronological order of the months around.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer The bar chart is displayed horizontally instead of vertically.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer The graph is easier to read and more simple without weird spaces or lines. Less color, minimal theme.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer The background color and theme is different as well as font size of the labels.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer There is a header explaining the type of data that the graph is displaying.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer I see the dates in regular month day year format with total calls.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer A very messy and hard to read line chart that displays the data through april to january.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer Dates labeled at the bottom but in a manner that cannot be read because of poor formatting.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer Text is slanted (labels) but easier to read than before.**
