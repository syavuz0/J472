...
second is taking the terms and grouping the results by them

third and fourth is adding up the records in each term and dataset
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer the classes are grouped by term**
...
**Answer the code just says that the group is output by term and than that it needs to be overridden using the groups argument.**
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer the total seats are ordered in descending order.**
...
Compared to the previous codeblock, what has changed and how did that affect the result? What do the top terms have in common? **Answer there are more columns including the median and mean number of seats. the last two columns are stats about the total number of seats.**
...
**Answer Instead of term codes there is the department name following the classes, total seats, mean and median seats.**
...
1.  What are the maximum number of seats for each course and term specifically?

2.  Are the mean number of seats representative of the students in the department?

3.  Do the number of students total, are less, or greater than the number of seats offered?
