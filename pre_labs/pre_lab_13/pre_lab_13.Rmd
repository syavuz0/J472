...
**Task** Run the following code and describe the dataframe it outputs. **Answer This dataframe describes the education spending per pupil in 2021, the percentage growth domestic product, the percentage change in population and the winner of each state's popular vote in the 2020 election.**
...
**Task** Run the following code. Describe the plot. What pattern do you see? **Answer The only pattern that I can see is that the growth is more concentrated toward the middle of the graph with varying values for the gdp growth.**
...
**Task** Run the following code. Describe the plot. What do you see? **Answer There is less of a pattern here, but the data points are still somewhat centered toward the middle. There is a linear regression line.**
...
**Task** Run the following code. Describe the table output in terms of the strength of relationships between the variables. What do you see? **Answer There is NA values for certain columns and rows. Each row has incomplete data. There are also negative percentages which indicate a negative trend.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer I see that this specific block of code displays the t-value, degree of freedom and the p-value. The p-value is good, which is below 0.05.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer The p-value in this is 0.67 which is not good for the validity of the data. It is not below 0.05.**
...
**Task** Run the following code. Describe the table. What do you see? **Answer This table displays the mean gdp growth and mean of money spent per student in education, as well as the population growth in association with Biden and Trump's votes in the 2020 elections.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer This data also does not pass the p-value. It is not below 0.05.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer The data in this test is valid. The value is well below 0.05 which means it can be trusted.**
