...
**Q1.** How many departments have offered the courses with "Climate" in the title and at least one seat? Which department has offered the most? **A1. Atmostpheric and Oceanic Science has offered 68 courses with "Climate" in the title.**
...
**Q2.** Of the departments listed in A2, which one is the most interesting to you, and why? **A2. The most interesting department to me is University Honors. Considering the department is vague, I wonder why it is third on the list and offers 15 classes with climate in the title.**
...
**A3. Business and management, Economics, School of Music, Biologial Sciences Program, and Information Studies have the most courses in the Fall 2023 term with at least one syllabus posted.**
...
#the pattern of soending seems to increase over time. 
...
#the code seems correct however it isn't able to detect mutate or summarise as a function
...
#How complex can filtering get in terms of arranging numbers and categories?

maryland_expenses |>
  filter(amount == 1000)
  group_by(payee_type, amount)
  sumamrise(amount = n())
  
#this filters the highest number of money by payee
